  ...
  return (
    <div className="space-y-6">
      <div className="v2-card-raised rounded-[var(--v2-radius-xl)] p-5 sm:p-7">
        ...
        <div className="h-8 w-3/5 animate-pulse rounded-full bg-muted" />
        <div className="mt-3 h-4 w-4/5 animate-pulse rounded-full bg-muted/60" />
        <div className="mt-6 h-14 w-44 animate-pulse rounded-full bg-muted" />
      ...
      <div className="overflow-hidden rounded-[var(--v2-radius-xl)] border border-border bg-muted/20 p-5">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 space-y-2">
            ...
            <div className="h-3 w-52 animate-pulse rounded-full bg-muted/60" />
          </div>
          ...
          <div key={i} className="v2-card rounded-[var(--v2-radius-lg)] p-5">
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1 space-y-2.5">
                ...
                <div className="h-2 w-28 animate-pulse rounded-full bg-muted/60" />
              </div>
