...
export const transactionSelectClass =
  "v2-focus-ring h-11 w-full min-w-0 max-w-full rounded-2xl border border-border bg-white/[0.05] px-4 text-base md:text-sm text-white outline-none transition hover:bg-white/[0.07]";

export const compactSelectClass =
  "v2-focus-ring h-9 w-full min-w-0 rounded-xl border border-border bg-white/[0.05] px-3 text-base md:text-xs text-white outline-none transition hover:bg-white/[0.07]";
