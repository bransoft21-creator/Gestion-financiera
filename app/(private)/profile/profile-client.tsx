...
import { KeyRound, LogOut, Mail, Shield, Sparkles, User } from "lucide-react";
...
export function ProfileClient({ userEmail, userName, isBetaUser = false }: ProfileClientProps) {
    ...
    <>
      ...
      <div className="mx-auto max-w-2xl space-y-4">
        ...
        <PremiumCard variant="raised" className="relative overflow-hidden">
          <div className="pointer-events-none absolute inset-x-0 top-0 h-28 bg-[radial-gradient(circle_at_20%_0%,rgba(45,212,191,0.12),transparent_40%),radial-gradient(circle_at_80%_0%,rgba(96,165,250,0.10),transparent_38%)]" />
          ...
          <PremiumCard>
            <PremiumCardContent className="p-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-zinc-300">IA no habilitada</p>
          ...
          <PremiumCardContent className="divide-y divide-white/[0.06] p-0">
            ...
            <div className="flex items-center gap-3 px-5 py-4">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-500">Gestioná el acceso a tu cuenta.</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between gap-3 px-5 py-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-zinc-200">Contraseña</p>
                  <p className="text-xs text-zinc-500">Cambiala si sospechás acceso no autorizado.</p>
                </div>
              </div>
              <a
                href="/login"
