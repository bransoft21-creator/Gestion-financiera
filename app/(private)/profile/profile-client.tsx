  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-lg space-y-4">
        ...
        {/* Identity card — anchored for tutorial spotlight */}
        <PremiumCard
          data-tutorial="profile-summary"
          variant="raised"
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-2.5 flex flex-wrap gap-1.5">
                    {["Análisis mensual", "Smart Import", "Beta activa"].map((tag) => (
                      <span
                        key={tag}
            ...
            <PremiumCardContent className="p-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs leading-5 text-muted-foreground">
                    El acceso IA se está expandiendo gradualmente. Cuando esté habilitado para tu cuenta, lo verás activo aquí.
                  </p>
                </div>
              </div>
            </PremiumCardContent>
          ...
          <PremiumCardContent className="divide-y divide-border/50 p-0">
            ...
            <div className="flex items-center justify-between gap-3 px-5 py-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-foreground">Tutorial interactivo</p>
                  <p className="text-xs text-muted-foreground">Repasá las funciones principales paso a paso</p>
                </div>
              </div>
              <button
                type="button"
                onClick={startTutorial}
                className="flex shrink-0 items-center gap-1.5 rounded-xl border border-border bg-muted/30 px-3 py-1.5 text-xs font-semibold text-muted-foreground transition hover:bg-muted/70 hover:text-foreground"
              >
